...
public class ClientApiUserTransactionEJBOverHttpTestCase extends AbstractClientApiEJBOverHttpTestCase {
    ...
    private final String nodeName = "http://" + "localhost" + ":" + "8080" + "/" + SERVLET_DEPLOYMENT_NAME + "/";

    @Deployment
    public static Archive<?> getDeployment() {
        final EnterpriseArchive ear = ShrinkWrap.create(EnterpriseArchive.class, APP_NAME + ".ear");
        final JavaArchive jar = ShrinkWrap.create(JavaArchive.class, MODULE_NAME + ".jar");
        jar.addPackage(ClientApiUserTransactionEJBOverHttpTestCase.class.getPackage());
        jar.addClasses(AbstractEJBOverHttpTestCase.class, AbstractClientApiEJBOverHttpTestCase.class);
        jar.addAsManifestResource(ClientApiUserTransactionEJBOverHttpTestCase.class.getPackage(), "persistence.xml",
                "persistence.xml");
        ear.addAsModule(jar);
        return ear;
    }
